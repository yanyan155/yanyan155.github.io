...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Search */ \"./src/js/models/Search.js\");\n/* harmony import */ var _views_searchView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/searchView */ \"./src/js/views/searchView.js\");\n/* harmony import */ var _models_Clips__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/Clips */ \"./src/js/models/Clips.js\");\n/* harmony import */ var _views_clipsView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/clipsView */ \"./src/js/views/clipsView.js\");\n/* harmony import */ var _models_Slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/Slider */ \"./src/js/models/Slider.js\");\n/* harmony import */ var _views_sliderView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/sliderView */ \"./src/js/views/sliderView.js\");\n/* harmony import */ var _models_Swipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/Swipe */ \"./src/js/models/Swipe.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n\n\nvar state = {}; //let requestAnimationFrame = window.requestAnimationFrame;\n\n(function () {\n  var requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame;\n  window.requestAnimationFrame = requestAnimationFrame;\n})();\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  // start render SearchForm only after loading page\n  _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderSearchForm\"](); // create here slider object\n\n  state.slider = new _models_Slider__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n  document.querySelector('.search-form').addEventListener('submit', function (event) {\n    event.preventDefault();\n    searchController();\n  });\n  window.addEventListener('resize', function (event) {\n    if (document.querySelector('.content-wrapper')) {\n      var isContinue = sliderController(true);\n\n      if (isContinue) {\n        _views_clipsView__WEBPACK_IMPORTED_MODULE_3__[\"deleteClips\"]();\n        clipsController(state.slider.idsToLoad, false);\n      }\n    }\n  });\n  document.addEventListener('mousedown', function (event) {\n    showPage();\n\n    if (state.search) {\n      var startX = event.clientX;\n      state.swipe = new _models_Swipe__WEBPACK_IMPORTED_MODULE_6__[\"default\"](startX);\n    }\n  });\n  document.addEventListener('mouseup', function (event) {\n    if (state.search && state.swipe) {\n      var endX = event.clientX;\n      state.swipe.putEndX(endX);\n      var isListing = state.swipe.isNeedtoList(state.slider.page, state.slider.nthLi);\n      isListing ? swipeController() : false;\n    }\n  });\n  document.addEventListener('touchstart', function (event) {\n    showPage(); //event.preventDefault();\n\n    if (state.search) {\n      var startX = event.changedTouches[0].screenX;\n      state.swipe = new _models_Swipe__WEBPACK_IMPORTED_MODULE_6__[\"default\"](startX);\n    }\n  }, false);\n  document.addEventListener('touchend', function (event) {\n    //event.preventDefault();\n    if (state.search && state.swipe) {\n      var endX = event.changedTouches[0].screenX;\n      state.swipe.putEndX(endX);\n      var isListing = state.swipe.isNeedtoList(state.slider.page, state.slider.nthLi);\n      isListing ? swipeController() : false;\n    }\n  }, false);\n});\n\nvar searchController =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var query;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            query = _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"getInput\"]();\n\n            if (!query) {\n              _context.next = 8;\n              break;\n            }\n\n            // create new obj\n            state.search = new _models_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query); //prepare UI to rendering\n\n            _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"clearSearchInput\"]();\n            _views_clipsView__WEBPACK_IMPORTED_MODULE_3__[\"deleteClips\"](); // create request\n\n            _context.next = 7;\n            return state.search.httpRequestSearch();\n\n          case 7:\n            if (true) {\n              sliderController(false);\n              clipsController(state.slider.idsToLoad, true);\n            }\n\n          case 8:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this);\n  }));\n\n  return function searchController() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar clipsController =\n/*#__PURE__*/\nfunction () {\n  var _ref2 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee2(array, isNeedCreateNewObj, direction) {\n    var clipdata;\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            // create new object\n            if (!state.clips || isNeedCreateNewObj) {\n              state.clips = new _models_Clips__WEBPACK_IMPORTED_MODULE_2__[\"default\"](array);\n            } // create request\n\n\n            _context2.next = 3;\n            return state.clips.httpRequestClips(array);\n\n          case 3:\n            clipdata = _context2.sent;\n            setTimeout(function () {\n              // write clips data to state.clips.clips\n              clipdata.forEach(function (elem) {\n                return state.clips.createClip(elem);\n              }); // delete old clips\n\n              _views_clipsView__WEBPACK_IMPORTED_MODULE_3__[\"deleteClips\"](); // render new clips\n\n              _views_clipsView__WEBPACK_IMPORTED_MODULE_3__[\"renderClipWrap\"](state.clips.clips.slice(state.slider.firstItemCount, state.slider.lastItemCount));\n            }, 300);\n\n          case 5:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2, this);\n  }));\n\n  return function clipsController(_x, _x2, _x3) {\n    return _ref2.apply(this, arguments);\n  };\n}();\n\nvar sliderController = function sliderController(isResizeEvent) {\n  var isNeedRacalculate = state.slider.calculateItemsPerPage();\n\n  if (isNeedRacalculate) {\n    state.slider.recalcilatePageAndNthLi();\n  }\n\n  if (!isResizeEvent || isResizeEvent && isNeedRacalculate) {\n    state.slider.findIdtoLoad(state.search.ids);\n\n    if (document.querySelector('.pagination-wrap')) {\n      _views_sliderView__WEBPACK_IMPORTED_MODULE_5__[\"changeActiveLi\"](state.slider.nthLi);\n    } else {\n      _views_sliderView__WEBPACK_IMPORTED_MODULE_5__[\"renderPadinbation\"](state.slider.page);\n    }\n\n    return true;\n  }\n\n  return false;\n};\n\nvar swipeController =\n/*#__PURE__*/\nfunction () {\n  var _ref3 = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee3() {\n    return regeneratorRuntime.wrap(function _callee3$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            _views_sliderView__WEBPACK_IMPORTED_MODULE_5__[\"animate\"]({\n              duration: 200,\n              timing: function timing(timeFraction) {\n                return timeFraction;\n              },\n              direction: state.swipe.direction\n            });\n            state.slider.changeNthLi(state.swipe.direction);\n            state.search.smoothLoading(state.slider.firstItemCount);\n            state.slider.findIdtoLoad(state.search.ids);\n            _views_sliderView__WEBPACK_IMPORTED_MODULE_5__[\"changeActiveLi\"](state.slider.nthLi);\n            _views_sliderView__WEBPACK_IMPORTED_MODULE_5__[\"changePage\"](state.slider.page);\n            clipsController(state.slider.idsToLoad, false, state.swipe.direction);\n\n          case 7:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _callee3, this);\n  }));\n\n  return function swipeController() {\n    return _ref3.apply(this, arguments);\n  };\n}(); // TODO Support at least one mobile browser(e.g. iOS / Android / WP);\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/models/Clips.js":
/*!********************************!*\
  !*** ./src/js/models/Clips.js ***!
  \********************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Clips; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Clips =\n/*#__PURE__*/\nfunction () {\n  function Clips(array) {\n    _classCallCheck(this, Clips);\n\n    this.clips = [];\n    this.ids = array;\n    this.page = 1;\n    this.itemsPerPage = 4;\n  }\n\n  _createClass(Clips, [{\n    key: \"createClip\",\n    value: function createClip(data) {\n      var id = data.id;\n      var image = data.snippet.thumbnails.default.url;\n      var title = data.snippet.localized.title;\n      var author = data.snippet.channelTitle;\n      var views = data.statistics.viewCount;\n      var date = data.snippet.publishedAt;\n      var description = data.snippet.localized.description;\n      var item = {\n        id: id,\n        image: image,\n        title: title,\n        author: author,\n        views: views,\n        date: date,\n        description: description\n      };\n      this.clips.push(item);\n    }\n  }, {\n    key: \"httpRequestClips\",\n    value: function () {\n      var _httpRequestClips = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee(array) {\n        var idString, key, url, tail, result, data;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                idString = array.reduce(function (prev, curr) {\n                  return \"\".concat(prev, \",\").concat(curr);\n                });\n                key = 'AIzaSyAxfbgsVbnwsMHqReQimHx5ptyX-ehHxY0';\n                url = 'https://www.googleapis.com/youtube/v3/videos';\n                tail = 'part=snippet,statistics';\n                _context.next = 6;\n                return fetch(\"\".concat(url, \"?key=\").concat(key, \"&\").concat(tail, \"&id=\").concat(idString));\n\n              case 6:\n                result = _context.sent;\n                _context.next = 9;\n                return result.json();\n\n              case 9:\n                data = _context.sent;\n                return _context.abrupt(\"return\", data.items);\n\n              case 11:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      return function httpRequestClips(_x) {\n        return _httpRequestClips.apply(this, arguments);\n      };\n    }()\n  }]);\n\n  return Clips;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/models/Clips.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Search; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Search =\n/*#__PURE__*/\nfunction () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n    this.ids = [];\n  }\n\n  _createClass(Search, [{\n    key: \"httpRequestSearch\",\n    value: function () {\n      var _httpRequestSearch = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee() {\n        var key, url, tail, result, data, items;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                key = 'AIzaSyAxfbgsVbnwsMHqReQimHx5ptyX-ehHxY0';\n                url = 'https://www.googleapis.com/youtube/v3/search';\n                tail = 'type=video&part=snippet&maxResults=15';\n                _context.next = 5;\n                return fetch(\"\".concat(url, \"?key=\").concat(key, \"&\").concat(tail, \"&q=\").concat(this.query).concat(this.createPageTokenString()));\n\n              case 5:\n                result = _context.sent;\n                _context.next = 8;\n                return result.json();\n\n              case 8:\n                data = _context.sent;\n                this.nextPageToken = data.nextPageToken;\n                items = data.items;\n                this.ids = this.ids.concat(items.map(function (elem) {\n                  return elem.id.videoId;\n                }));\n                return _context.abrupt(\"return\", this.ids);\n\n              case 13:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      return function httpRequestSearch() {\n        return _httpRequestSearch.apply(this, arguments);\n      };\n    }()\n  }, {\n    key: \"createPageTokenString\",\n    value: function createPageTokenString() {\n      if (this.nextPageToken) {\n        return \"&pageToken=\".concat(this.nextPageToken);\n      }\n\n      return '';\n    }\n  }, {\n    key: \"smoothLoading\",\n    value: function () {\n      var _smoothLoading = _asyncToGenerator(\n      /*#__PURE__*/\n      regeneratorRuntime.mark(function _callee2(firstItemCount) {\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                if (!(this.ids.length - firstItemCount < 15)) {\n                  _context2.next = 4;\n                  break;\n                }\n\n                _context2.next = 3;\n                return this.httpRequestSearch();\n\n              case 3:\n                return _context2.abrupt(\"return\", this.ids);\n\n              case 4:\n                return _context2.abrupt(\"return\", false);\n\n              case 5:\n              case \"end\":\n                return _context2.stop();\n            }\n          }\n        }, _callee2, this);\n      }));\n\n      return function smoothLoading(_x) {\n        return _smoothLoading.apply(this, arguments);\n      };\n    }()\n  }]);\n\n  return Search;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");

/***/ }),

/***/ "./src/js/models/Slider.js":
/*!*********************************!*\
  !*** ./src/js/models/Slider.js ***!
  \*********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Swipe; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Swipe =\n/*#__PURE__*/\nfunction () {\n  function Swipe(startX) {\n    _classCallCheck(this, Swipe);\n\n    this.startX = startX;\n    this.endX = null;\n    this.deltaX = null;\n  }\n\n  _createClass(Swipe, [{\n    key: \"putEndX\",\n    value: function putEndX(endX) {\n      this.endX = endX;\n    }\n  }, {\n    key: \"isNeedtoList\",\n    value: function isNeedtoList(page, nthLi) {\n      var width = window.innerWidth;\n      width = width > 1000 ? 1000 : width;\n      this.deltaX = this.endX - this.startX;\n      var moduleDeltaX = this.deltaX >= 0 ? this.deltaX : -this.deltaX;\n      this.direction = this.deltaX >= 0 ? 'left' : 'right';\n\n      if (page === 0 && nthLi === 0 && this.direction === 'left' || width / 3 >= moduleDeltaX) {\n        return false;\n      }\n\n      return true;\n    }\n  }]);\n\n  return Swipe;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/models/Swipe.js?");

/***/ }),

/***/ "./src/js/views/clipsView.js":
/*!***********************************!*\
  !*** ./src/js/views/clipsView.js ***!
  \***********************************/
/*! exports provided: renderClip, renderClipWrap, deleteClips */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderClip\", function() { return renderClip; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderClipWrap\", function() { return renderClipWrap; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteClips\", function() { return deleteClips; });\nvar renderClip = function renderClip(id, image, title, author, views, date, description) {\n  var markup = \"\\n      <div class=\\\"clip-item\\\" data-videoId=\\\"\".concat(id, \"\\\">\\n        <img src=\\\"\").concat(image, \"\\\" alt=\\\"\").concat(title, \"\\\" width=\\\"100\\\" height=\\\"100\\\">\\n        <a href=\\\"https://www.youtube.com/watch?v=\").concat(id, \"\\\" title=\\\"\").concat(title, \"\\\">\").concat(title, \"</a>\\n        <p class=\\\"clip-item-author\\\"><i class=\\\"fa fa-user\\\" aria-hidden=\\\"true\\\"></i> \").concat(author, \"</p>\\n        <p class=\\\"clip-item-views\\\"><i class=\\\"fa fa-eye\\\" aria-hidden=\\\"true\\\"></i> \").concat(views, \"</p>\\n        <p class=\\\"clip-item-date\\\"><i class=\\\"fa fa-calendar\\\" aria-hidden=\\\"true\\\"></i> \").concat(cutDate(date), \"</p>\\n        <p class=\\\"clip-item-description\\\">\").concat(description, \"</p>\\n      </div>\\n    \");\n  document.querySelector('.content-wrapper').insertAdjacentHTML('beforeend', markup);\n};\nvar renderClipWrap = function renderClipWrap(array) {\n  var markupWrap = \"<div class=\\\"content-wrapper\\\"></div>\";\n  document.querySelector('.wrap').insertAdjacentHTML('beforeend', markupWrap);\n  array.forEach(function (item) {\n    renderClip(item.id, item.image, item.title, item.author, item.views, item.date, item.description);\n  });\n};\nvar deleteClips = function deleteClips() {\n  var domWrapper = document.querySelector('.content-wrapper');\n\n  if (domWrapper) {\n    domWrapper.parentElement.removeChild(domWrapper);\n  }\n};\n\nvar cutDate = function cutDate(string) {\n  var index = string.indexOf('T');\n  return string.slice(0, index);\n};\n/*export const addAnimationOut = (direction) => {\r\n  if(direction) {\r\n    const value = `${animationFunc(direction)} 0.3s 1 ease;`;\r\n    const attribute = 'animation';\r\n    const wrapper = document.querySelector('.content-wrapper')\r\n    wrapper.setAttribute(attribute, value);\r\n    wrapper.setAttribute('animation-play-state', 'running');\r\n  }\r\n}\r\nconst animationFunc = (direction) => {\r\n  if (direction === 'left') {\r\n    return 'moveOutRight';\r\n  } else if(direction === 'right') {\r\n    return 'moveOutLeft';\r\n  }\r\n}*/\n\n//# sourceURL=webpack:///./src/js/views/clipsView.js?");
...
/*!************************************!*\
  !*** ./src/js/views/sliderView.js ***!
  \************************************/
/*! exports provided: renderPadinbation, changePage, changeActiveLi, animate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderPadinbation\", function() { return renderPadinbation; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changePage\", function() { return changePage; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changeActiveLi\", function() { return changeActiveLi; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"animate\", function() { return animate; });\nvar renderPadinbation = function renderPadinbation(page) {\n  var markup = \"\\n    <div class=\\\"pagination-wrap\\\">\\n      <ul class=\\\"pagination\\\">\\n        <li class=\\\"active\\\" data-nth=\\\"0\\\"><span>\".concat(page + 1, \"</span></li>\\n        <li data-nth=\\\"1\\\"><span>\").concat(page + 1, \"</span></li>\\n        <li data-nth=\\\"2\\\"><span>\").concat(page + 1, \"</span></li>\\n      </ul>\\n    </div>\\n    \");\n  document.querySelector('.wrap').insertAdjacentHTML('beforeend', markup);\n};\nvar changePage = function changePage(page) {\n  var domSpans = document.querySelectorAll('.pagination span');\n  var arraySpans = Array.from(domSpans);\n  arraySpans.forEach(function (elem) {\n    elem.innerHTML = page + 1;\n  });\n};\nvar changeActiveLi = function changeActiveLi(nthLi) {\n  var domSpans = document.querySelectorAll('.pagination li');\n  var arraySpans = Array.from(domSpans);\n  arraySpans.forEach(function (elem, i) {\n    elem.classList.remove(\"active\");\n\n    if (i === nthLi) {\n      elem.classList.add(\"active\");\n    }\n  });\n};\n\nvar draw = function draw(progress, direction) {\n  var value = progress * 100 + '%';\n  document.querySelector('.content-wrapper').style[direction] = value;\n};\n\nvar animate = function animate(options) {\n  var start = performance.now();\n  requestAnimationFrame(function animate(time) {\n    var timeFraction = (time - start) / options.duration;\n    if (timeFraction > 1) timeFraction = 1;\n    var progress = options.timing(timeFraction);\n\n    if (options.direction) {\n      draw(progress, options.direction);\n    } else if (options.domElem) {\n      drawPage(progress, options.domElem);\n    }\n\n    if (timeFraction < 1) {\n      requestAnimationFrame(animate);\n    }\n  });\n};\n\nvar drawPage = function drawPage(progress, elem) {\n  var value = 1 - progress;\n  elem.style[\"opacity\"] = value;\n};\n\n//# sourceURL=webpack:///./src/js/views/sliderView.js?");
